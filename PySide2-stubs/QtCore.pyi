...
class QObject(Shiboken.Object):
    ...
    @typing.overload
    def findChildren(self, arg__1:typing.Type[T], arg__2:PySide2.QtCore.QRegExp) -> typing.List[T]: ...
    @typing.overload
    def findChildren(self, arg__1:typing.Type[T], arg__2:PySide2.QtCore.QRegularExpression) -> typing.List[T]: ...
    @typing.overload
