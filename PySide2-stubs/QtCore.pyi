...
class QObject(Shiboken.Object):
    ...
    @typing.overload
    def connect(self, arg__1:str, arg__2:typing.Callable, type:PySide2.QtCore.Qt.ConnectionType=...) -> bool: ...
    @typing.overload
    def connect(self, arg__1:str, arg__2:PySide2.QtCore.QObject, arg__3:str, type:PySide2.QtCore.Qt.ConnectionType=...) -> bool: ...
    @typing.overload
    def connect(self, sender:PySide2.QtCore.QObject, signal:str, member:str, type:PySide2.QtCore.Qt.ConnectionType=...) -> PySide2.QtCore.QMetaObject.Connection: ...
    @typing.overload
    @staticmethod
    ...
    @typing.overload
    def disconnect(self, arg__1:str, arg__2:typing.Callable) -> bool: ...
    @typing.overload
    def disconnect(self, receiver:PySide2.QtCore.QObject, member:typing.Optional[str]=...) -> bool: ...
    @typing.overload
    def disconnect(self, signal:bytes, receiver:PySide2.QtCore.QObject, member:str) -> bool: ...
    @typing.overload
    @staticmethod
