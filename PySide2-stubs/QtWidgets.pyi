...
class QFileDialog(PySide2.QtWidgets.QDialog):
    ...
    @staticmethod
    def getOpenFileName(parent:typing.Optional[PySide2.QtWidgets.QWidget]=..., caption:str=..., dir:str=..., filter:str=..., selectedFilter:str=..., options:PySide2.QtWidgets.QFileDialog.Options=...) -> typing.Tuple: ...
    @staticmethod
    def getOpenFileNames(parent:typing.Optional[PySide2.QtWidgets.QWidget]=..., caption:str=..., dir:str=..., filter:str=..., selectedFilter:str=..., options:PySide2.QtWidgets.QFileDialog.Options=...) -> typing.Tuple: ...
    @staticmethod
    def getOpenFileUrl(parent:typing.Optional[PySide2.QtWidgets.QWidget]=..., caption:str=..., dir:PySide2.QtCore.QUrl=..., filter:str=..., selectedFilter:str=..., options:PySide2.QtWidgets.QFileDialog.Options=..., supportedSchemes:typing.Sequence=...) -> typing.Tuple: ...
    @staticmethod
    def getOpenFileUrls(parent:typing.Optional[PySide2.QtWidgets.QWidget]=..., caption:str=..., dir:PySide2.QtCore.QUrl=..., filter:str=..., selectedFilter:str=..., options:PySide2.QtWidgets.QFileDialog.Options=..., supportedSchemes:typing.Sequence=...) -> typing.Tuple: ...
    @staticmethod
    def getSaveFileName(parent:typing.Optional[PySide2.QtWidgets.QWidget]=..., caption:str=..., dir:str=..., filter:str=..., selectedFilter:str=..., options:PySide2.QtWidgets.QFileDialog.Options=...) -> typing.Tuple: ...
    @staticmethod
    def getSaveFileUrl(parent:typing.Optional[PySide2.QtWidgets.QWidget]=..., caption:str=..., dir:PySide2.QtCore.QUrl=..., filter:str=..., selectedFilter:str=..., options:PySide2.QtWidgets.QFileDialog.Options=..., supportedSchemes:typing.Sequence=...) -> typing.Tuple: ...
