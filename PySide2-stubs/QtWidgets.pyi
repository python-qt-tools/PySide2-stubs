...
class QDialogButtonBox(PySide2.QtWidgets.QWidget):
    ...
    class StandardButtons(object):
        ...
        def __index__(self) -> int: ...
        def __init__(self, value: typing.Union[int, StandardButton, StandardButtons] = ...) -> None: ...
        def __or__(self, other: typing.Union[int, StandardButton, StandardButtons]) -> StandardButtons: ...
        def __and__(self, other: typing.Union[int, StandardButton, StandardButtons]) -> StandardButtons: ...
        def __xor__(self, other: typing.Union[int, StandardButton, StandardButtons]) -> StandardButtons: ...
        def __ror__(self, other: typing.Union[int, StandardButton, StandardButtons]) -> StandardButtons: ...
        def __rand__(self, other: typing.Union[int, StandardButton, StandardButtons]) -> StandardButtons: ...
...
class QTreeWidgetItem(Shiboken.Object):
    ...
    def setForeground(self, column:int, brush: typing.Union[PySide2.QtGui.QColor, PySide2.QtGui.QBrush]) -> None: ...
    def setHidden(self, hide:bool) -> None: ...
