...
class QAbstractPrintDialog(PySide2.QtWidgets.QDialog):
    ...
    class PrintDialogOption(object):
        ...
        def __init__(self, value: typing.Union[int, PrintDialogOption] = ...) -> None: ...
        def __or__(self, other: typing.Union[int, PrintDialogOption]) -> PrintDialogOptions: ...
        def __and__(self, other: typing.Union[int, PrintDialogOption]) -> PrintDialogOptions: ...
        def __xor__(self, other: typing.Union[int, PrintDialogOption]) -> PrintDialogOptions: ...
        def __ror__(self, other: typing.Union[int, PrintDialogOption]) -> PrintDialogOptions: ...
        def __rand__(self, other: typing.Union[int, PrintDialogOption]) -> PrintDialogOptions: ...
        def __rxor__(self, other: typing.Union[int, PrintDialogOption]) -> PrintDialogOptions: ...
        def __ior__(self, other: typing.Union[int, PrintDialogOption]) -> PrintDialogOptions: ...
        def __iand__(self, other: typing.Union[int, PrintDialogOption]) -> PrintDialogOptions: ...
        def __ixor__(self, other: typing.Union[int, PrintDialogOption]) -> PrintDialogOptions: ...
        def __invert__(self) -> PrintDialogOptions: ...

    class PrintDialogOptions(object):
        
        def __index__(self) -> int: ...
        def __init__(self, value: typing.Union[int, PrintDialogOption, PrintDialogOptions] = ...) -> None: ...
        def __or__(self, other: typing.Union[int, PrintDialogOption, PrintDialogOptions]) -> PrintDialogOptions: ...
        def __and__(self, other: typing.Union[int, PrintDialogOption, PrintDialogOptions]) -> PrintDialogOptions: ...
        def __xor__(self, other: typing.Union[int, PrintDialogOption, PrintDialogOptions]) -> PrintDialogOptions: ...
        def __ror__(self, other: typing.Union[int, PrintDialogOption, PrintDialogOptions]) -> PrintDialogOptions: ...
        def __rand__(self, other: typing.Union[int, PrintDialogOption, PrintDialogOptions]) -> PrintDialogOptions: ...
        def __rxor__(self, other: typing.Union[int, PrintDialogOption, PrintDialogOptions]) -> PrintDialogOptions: ...
        def __ior__(self, other: typing.Union[int, PrintDialogOption, PrintDialogOptions]) -> PrintDialogOptions: ...
        def __iand__(self, other: typing.Union[int, PrintDialogOption, PrintDialogOptions]) -> PrintDialogOptions: ...
        def __ixor__(self, other: typing.Union[int, PrintDialogOption, PrintDialogOptions]) -> PrintDialogOptions: ...
        def __invert__(self) -> PrintDialogOptions: ...
...
class QPrintPreviewDialog(PySide2.QtWidgets.QDialog):
    ...
    @typing.overload
    def __init__(self, printer:PySide2.QtPrintSupport.QPrinter, parent:typing.Optional[PySide2.QtWidgets.QWidget]=..., flags:typing.Union[PySide2.QtCore.Qt.WindowFlags, PySide2.QtCore.Qt.WindowType]=...) -> None: ...
