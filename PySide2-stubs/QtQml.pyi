...
class QJSEngine(PySide2.QtCore.QObject):
    ...
    class Extension(object):
        ...
        def __init__(self, value: typing.Union[int, Extension] = ...) -> None: ...
        def __or__(self, other: typing.Union[int, Extension]) -> Extensions: ...
        def __and__(self, other: typing.Union[int, Extension]) -> Extensions: ...
        def __xor__(self, other: typing.Union[int, Extension]) -> Extensions: ...
        def __ror__(self, other: typing.Union[int, Extension]) -> Extensions: ...
        def __rand__(self, other: typing.Union[int, Extension]) -> Extensions: ...
        def __rxor__(self, other: typing.Union[int, Extension]) -> Extensions: ...
        def __ior__(self, other: typing.Union[int, Extension]) -> Extensions: ...
        def __iand__(self, other: typing.Union[int, Extension]) -> Extensions: ...
        def __ixor__(self, other: typing.Union[int, Extension]) -> Extensions: ...
        def __invert__(self) -> Extensions: ...

    class Extensions(object):
        
        def __index__(self) -> int: ...
        def __init__(self, value: typing.Union[int, Extension, Extensions] = ...) -> None: ...
        def __or__(self, other: typing.Union[int, Extension, Extensions]) -> Extensions: ...
        def __and__(self, other: typing.Union[int, Extension, Extensions]) -> Extensions: ...
        def __xor__(self, other: typing.Union[int, Extension, Extensions]) -> Extensions: ...
        def __ror__(self, other: typing.Union[int, Extension, Extensions]) -> Extensions: ...
        def __rand__(self, other: typing.Union[int, Extension, Extensions]) -> Extensions: ...
        def __rxor__(self, other: typing.Union[int, Extension, Extensions]) -> Extensions: ...
        def __ior__(self, other: typing.Union[int, Extension, Extensions]) -> Extensions: ...
        def __iand__(self, other: typing.Union[int, Extension, Extensions]) -> Extensions: ...
        def __ixor__(self, other: typing.Union[int, Extension, Extensions]) -> Extensions: ...
        def __invert__(self) -> Extensions: ...
...
def qmlRegisterType(url: typing.Type[PySide2.QtCore.QObject], uri: str, version_major: int, version_minor: int, qml_name: str) -> int: ...
