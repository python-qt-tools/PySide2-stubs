...
class QGLColormap(Shiboken.Object):
    ...
    @typing.overload
    def setEntry(self, idx:int, color: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int]) -> None: ...
    @typing.overload
...
class QGLContext(Shiboken.Object):
    ...
    class BindOption(object):
        ...
        def __index__(self) -> int: ...
        def __init__(self, value: typing.Union[int, BindOption] = ...) -> None: ...
        def __or__(self, other: typing.Union[int, BindOption]) -> BindOptions: ...
        def __and__(self, other: typing.Union[int, BindOption]) -> BindOptions: ...
        def __xor__(self, other: typing.Union[int, BindOption]) -> BindOptions: ...
        def __ror__(self, other: typing.Union[int, BindOption]) -> BindOptions: ...
        def __rand__(self, other: typing.Union[int, BindOption]) -> BindOptions: ...
        def __rxor__(self, other: typing.Union[int, BindOption]) -> BindOptions: ...
        def __ior__(self, other: typing.Union[int, BindOption]) -> BindOptions: ...
        def __iand__(self, other: typing.Union[int, BindOption]) -> BindOptions: ...
        def __ixor__(self, other: typing.Union[int, BindOption]) -> BindOptions: ...
        def __invert__(self) -> BindOptions: ...

    class BindOptions(object):
        
        def __index__(self) -> int: ...
        def __init__(self, value: typing.Union[int, BindOption, BindOptions] = ...) -> None: ...
        def __or__(self, other: typing.Union[int, BindOption, BindOptions]) -> BindOptions: ...
        def __and__(self, other: typing.Union[int, BindOption, BindOptions]) -> BindOptions: ...
        def __xor__(self, other: typing.Union[int, BindOption, BindOptions]) -> BindOptions: ...
        def __ror__(self, other: typing.Union[int, BindOption, BindOptions]) -> BindOptions: ...
        def __rand__(self, other: typing.Union[int, BindOption, BindOptions]) -> BindOptions: ...
        def __rxor__(self, other: typing.Union[int, BindOption, BindOptions]) -> BindOptions: ...
        def __ior__(self, other: typing.Union[int, BindOption, BindOptions]) -> BindOptions: ...
        def __iand__(self, other: typing.Union[int, BindOption, BindOptions]) -> BindOptions: ...
        def __ixor__(self, other: typing.Union[int, BindOption, BindOptions]) -> BindOptions: ...
        def __invert__(self) -> BindOptions: ...
    ...
    def colorIndex(self, c: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int]) -> int: ...
...
class QGLFormat(Shiboken.Object):
    ...
    class OpenGLVersionFlag(object):
        ...
        def __index__(self) -> int: ...
        def __init__(self, value: typing.Union[int, OpenGLVersionFlag] = ...) -> None: ...
        def __or__(self, other: typing.Union[int, OpenGLVersionFlag]) -> OpenGLVersionFlags: ...
        def __and__(self, other: typing.Union[int, OpenGLVersionFlag]) -> OpenGLVersionFlags: ...
        def __xor__(self, other: typing.Union[int, OpenGLVersionFlag]) -> OpenGLVersionFlags: ...
        def __ror__(self, other: typing.Union[int, OpenGLVersionFlag]) -> OpenGLVersionFlags: ...
        def __rand__(self, other: typing.Union[int, OpenGLVersionFlag]) -> OpenGLVersionFlags: ...
        def __rxor__(self, other: typing.Union[int, OpenGLVersionFlag]) -> OpenGLVersionFlags: ...
        def __ior__(self, other: typing.Union[int, OpenGLVersionFlag]) -> OpenGLVersionFlags: ...
        def __iand__(self, other: typing.Union[int, OpenGLVersionFlag]) -> OpenGLVersionFlags: ...
        def __ixor__(self, other: typing.Union[int, OpenGLVersionFlag]) -> OpenGLVersionFlags: ...
        def __invert__(self) -> OpenGLVersionFlags: ...

    class OpenGLVersionFlags(object):
        
        def __index__(self) -> int: ...
        def __init__(self, value: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags] = ...) -> None: ...
        def __or__(self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]) -> OpenGLVersionFlags: ...
        def __and__(self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]) -> OpenGLVersionFlags: ...
        def __xor__(self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]) -> OpenGLVersionFlags: ...
        def __ror__(self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]) -> OpenGLVersionFlags: ...
        def __rand__(self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]) -> OpenGLVersionFlags: ...
        def __rxor__(self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]) -> OpenGLVersionFlags: ...
        def __ior__(self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]) -> OpenGLVersionFlags: ...
        def __iand__(self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]) -> OpenGLVersionFlags: ...
        def __ixor__(self, other: typing.Union[int, OpenGLVersionFlag, OpenGLVersionFlags]) -> OpenGLVersionFlags: ...
        def __invert__(self) -> OpenGLVersionFlags: ...
...
class QGLWidget(PySide2.QtWidgets.QWidget):
    ...
    @typing.overload
    def __init__(self, context:PySide2.QtOpenGL.QGLContext, parent:typing.Optional[PySide2.QtWidgets.QWidget]=..., shareWidget:typing.Optional[PySide2.QtOpenGL.QGLWidget]=..., f:typing.Union[PySide2.QtCore.Qt.WindowFlags, PySide2.QtCore.Qt.WindowType]=...) -> None: ...
    @typing.overload
    def __init__(self, format:PySide2.QtOpenGL.QGLFormat, parent:typing.Optional[PySide2.QtWidgets.QWidget]=..., shareWidget:typing.Optional[PySide2.QtOpenGL.QGLWidget]=..., f:typing.Union[PySide2.QtCore.Qt.WindowFlags, PySide2.QtCore.Qt.WindowType]=...) -> None: ...
    @typing.overload
    def __init__(self, parent:typing.Optional[PySide2.QtWidgets.QWidget]=..., shareWidget:typing.Optional[PySide2.QtOpenGL.QGLWidget]=..., f:typing.Union[PySide2.QtCore.Qt.WindowFlags, PySide2.QtCore.Qt.WindowType]=...) -> None: ...
    ...
    def qglClearColor(self, c: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int]) -> None: ...
    def qglColor(self, c: Union[PySide2.QtGui.QColor, PySide2.QtCore.Qt.GlobalColor, str, int]) -> None: ...
