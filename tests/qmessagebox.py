...
multiple_buttons = QMessageBox.StandardButtons(QMessageBox.StandardButton.Ok | QMessageBox.StandardButton.Ok)
...
my_warning = QMessageBox.warning # type: Callable[[None, str, str], QMessageBox.StandardButton]
